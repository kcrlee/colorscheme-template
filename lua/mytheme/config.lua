...
---@class mytheme.Config
---@field on_colors fun(colors: ColorScheme)
---@field on_highlights fun(highlights: mytheme.Highlights, colors: ColorScheme)
M.defaults = {
  ...
  ---@param highlights mytheme.Highlights
  ---@param colors ColorScheme
