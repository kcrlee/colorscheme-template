...
.theme-dark {
  ...
  --text-muted: ${fg_dim};
  --text-link: ${blue};
  --text-link-low-saturation: ${blue_bright};
  --text-positive: ${hint};
  ...
  --info-danger-text: ${fg};
  --info-help-background: ${blue_bright}26;
  ...
  --premium-perk-light-blue: ${cyan_bright};
  ...
  --button-danger-background-active: ${blue_bright};
  --button-danger-background-disabled: ${red};
  --button-positive-background: ${hint};
  --button-positive-background-hover: ${green_bright};
  --button-positive-background-active: ${teal_dim};
  ...
  --button-outline-positive-background-active: ${green_bright};
  ...
  --button-outline-brand-background-hover: ${cyan_bright};
  --button-outline-brand-text-hover: ${bg};
  --button-outline-brand-border-hover: ${cyan_bright};
  --button-outline-brand-background-active: ${blue};
  --button-outline-brand-text-active: ${bg};
  --button-outline-brand-border-active: ${cyan_bright};
  ...
  --bg-mod-subtle: ${fg_ghost};
  --focus-primary: ${blue};
  --interactive-normal: ${fg};
  --interactive-muted: ${fg_muted}4C;
  --interactive-hover: ${fg};
  --interactive-active: ${fg};
  --search-popout-option-non-text-color: ${fg_dim};
  --__spoiler-background-color--hidden: ${blue_muted};
