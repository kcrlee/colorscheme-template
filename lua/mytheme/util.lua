...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("mytheme.hsluv")
    if color ~= "NONE" then
...
---@param groups mytheme.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/mytheme-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, mytheme.Cache
