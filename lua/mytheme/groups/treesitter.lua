...
function M.get(c, opts)
  ...
  local ret = {
    ...
    ["@constructor.tsx"]            = { fg = c.cyan_bright },
    ...
    ["@markup.list"]                = { fg = c.blue_bright }, -- For special punctutation that does not fall in the categories before.
    ["@markup.list.checked"]        = { fg = c.green_bright }, -- For brackets and parens.
    ["@markup.list.markdown"]       = { fg = c.orange, bold = true },
    ["@markup.list.unchecked"]      = { fg = c.blue }, -- For brackets and parens.
    ["@markup.math"]                = "Special",
    ["@markup.raw"]                 = "String",
    ["@markup.raw.markdown_inline"] = { bg = c.fg_ghost, fg = c.blue },
    ...
    ["@number"]                     = "Number",
    ["@number.float"]               = "Float",
    ["@operator"]                   = { fg = c.blue_bright }, -- For any operator: `+`, but also `->` and `*` in C.
    ["@property"]                   = { fg = c.green_bright },
    ["@punctuation.bracket"]        = { fg = c.fg_dim }, -- For brackets and parens.
    ["@punctuation.delimiter"]      = { fg = c.blue_bright }, -- For delimiters ie: `.`
    ["@punctuation.special"]        = { fg = c.blue_bright }, -- For special symbols (e.g. `{}` in string interpolation)
    ["@punctuation.special.markdown"] = { fg = c.orange }, -- For special symbols (e.g. `{}` in string interpolation)
    ["@string"]                     = "String",
    ["@string.documentation"]       = { fg = c.yellow },
    ["@string.escape"]              = { fg = c.magenta }, -- For escape characters within a string.
    ["@string.regexp"]              = { fg = c.cyan_pale }, -- For regexes.
    ["@tag"]                        = "Label",
    ...
    ["@type"]                       = "Type",
    ["@type.builtin"]               = { fg = Util.blend_bg(c.cyan_bright, 0.8) },
    ...
    ["@variable.member"]            = { fg = c.green_bright }, -- For fields.
