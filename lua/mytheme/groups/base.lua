...
function M.get(c, opts)
  ...
  return {
    ...
    PmenuMatch                  = { bg = c.bg_popup, fg = c.cyan_bright }, -- Popup menu: Matched text in normal item.
    PmenuSel                    = { bg = Util.blend_bg(c.fg_gutter, 0.8) }, -- Popup menu: selected item.
    PmenuMatchSel               = { bg = Util.blend_bg(c.fg_gutter, 0.8), fg = c.cyan_bright }, -- Popup menu: Matched text in selected item.
    ...
    Keyword                     = { fg = c.cyan_light, style = opts.styles.keywords }, --  any other keyword
    Operator                    = { fg = c.blue_bright }, -- "sizeof", "+", "*", etc.
    PreProc                     = { fg = c.cyan_light }, -- (preferred) generic Preprocessor
    Special                     = { fg = c.cyan_bright }, -- (preferred) any special symbol
    Statement                   = { fg = c.magenta }, -- (preferred) any statement
    String                      = { fg = c.green }, --   a string constant: "this is a string"
    Todo                        = { bg = c.yellow, fg = c.bg }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
    Type                        = { fg = c.cyan_bright }, -- (preferred) int, long, char, etc.
    ...
    helpCommand                 = { bg = c.fg_ghost, fg = c.blue },
    ...
    LspInlayHint                = { bg = Util.blend_bg(c.blue_muted, 0.1), fg = c.fg_muted },
    LspInfoBorder               = { fg = c.border_highlight, bg = c.bg_float },
    ComplHint                   = { fg = c.fg_ghost },
    ...
    DiagnosticUnnecessary       = { fg = c.fg_ghost }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default
    ...
    diffOldFile                 = { fg = c.cyan_bright, bg=c.diff.delete },
    diffNewFile                 = { fg = c.cyan_bright, bg=c.diff.add },
    diffFile                    = { fg = c.blue },
